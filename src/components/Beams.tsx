...
type UniformInput = { value: unknown } | unknown
...
const MergedPlanes = forwardRef<THREE.Mesh, MergedPlanesProps>(({ material, width, count, height }, ref) => {
  ...
  useFrame((_, delta) => {
    ...
    const materialWithUniforms = mesh.current.material as THREE.ShaderMaterial
    materialWithUniforms.uniforms.time.value += 0.1 * delta
  })
